      ...
      <div className="w-full max-w-[1728px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-10 py-5 md:py-8 pb-36 md:pb-8">
        ...
        <div className="flex flex-col lg:flex-row gap-4 xl:gap-6 2xl:gap-8 items-start w-full">
          ...
          >
            ...
            {/* Direct Lawyer Support Card - Đồng bộ phong cách Royal Champagne như bên Chatbot */}
            <div className="bg-gradient-to-b from-[#FFFDF8] via-[#FAF3E5] to-[#F5EAD4] border-2 border-amber-300/80 rounded-2xl p-4 sm:p-5 text-center shadow-lg shadow-amber-900/5 relative overflow-hidden group hover:shadow-xl transition-shadow">
              ...
              <div className="mt-4 pt-3.5 border-t border-amber-900/15 space-y-2">
                ...
                <Link
                  href="/appointment"
                  className="w-full bg-amber-400 hover:bg-amber-300 text-slate-950 h-9.5 rounded-xl text-xs font-bold flex items-center justify-center gap-2 transition-all shadow-md shadow-amber-400/20 active:scale-98"
                >
