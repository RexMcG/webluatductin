...
export default function AIFormChecker() {
  ...
  return (
    <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop pt-32 pb-8 page-fade-in flex-grow w-full min-h-screen">
      {/* HEADER AREA */}
      <header className="mb-8 border-b border-border-neutral pb-stack-md text-center max-w-4xl mx-auto">
        <h1 className="font-headline-xl-mobile md:font-headline-xl text-headline-xl-mobile md:text-headline-xl text-primary mb-stack-sm font-playfair">
