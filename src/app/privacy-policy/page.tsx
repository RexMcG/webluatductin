        ...
        <div className="bg-white rounded-2xl p-6 sm:p-12 border border-slate-200 shadow-xs space-y-8 text-slate-800 leading-relaxed text-sm sm:text-base">
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-6 space-y-2 text-slate-700">
              ...
              <li>
                <strong>Dữ liệu tương tác tiện ích trực tuyến:</strong> Câu hỏi gửi đến Trợ lý AI, văn bản tra cứu biểu mẫu hoặc tính toán án phí, lương Gross-Net. Dữ liệu này được xử lý phục vụ phiên làm việc và ẩn danh hóa an toàn.
              </li>
              <li>
