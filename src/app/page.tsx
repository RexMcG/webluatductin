...
export default function Home() {
  ...
  const SEARCH_NAV_ROUTES = [
    ...
    { keywords: ["hợp đồng", "thẩm định", "soát hợp đồng", "check hợp đồng", "rủi ro hợp đồng"], title: "AI Thẩm Định & Soát Hợp Đồng", href: "/ai-form-checker", icon: "fact_check", desc: "Tải file hợp đồng để AI quét lỗ hổng & rủi ro pháp lý" },
