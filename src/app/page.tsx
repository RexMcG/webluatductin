          ...
          {(() => {
            const lawyersList =
              siteContent.home.lawyers?.items && siteContent.home.lawyers.items.length > 0
                ? siteContent.home.lawyers.items
                : DEFAULT_SITE_CONTENT.home.lawyers.items;
            ...
            return (
              <div className={`grid grid-cols-1 ${lawyersList.length === 2 ? "md:grid-cols-2 max-w-4xl mx-auto" : "md:grid-cols-3"} gap-6 lg:gap-8`}>
                {lawyersList.map((ls, idx) => (
